...
import SoltoBTC from "../soltobtcln/SoltoBTCLN";
import { BN } from "@project-serum/anchor";
import { SoltoBTCSwapState } from "./SoltoBTCWrapper";
import { ConstantSoltoBTC } from "../../Constants";
import SwapType from "../SwapType";
export class SoltoBTCSwap {
    constructor(wrapper, addressOrObject, amount, confirmationTarget, confirmations, nonce, networkFee, swapFee, totalFee, total, minRequiredExpiry, offerExpiry, data, url, fromAddress) {
